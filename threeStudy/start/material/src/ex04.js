...
export default function example() {
  ...
  const ambiColortex = textureLoader.load(
    '/textures/bricks/Brick_Wall_016_ambientOcclusion.jpg',
  );
  const heightColortex = textureLoader.load(
    '/textures/bricks/Brick_Wall_016_height.png',
    );
  const normalColortex = textureLoader.load(
    '/textures/bricks/Brick_Wall_016_normal.jpg',
    );
  const roughColortex = textureLoader.load(
    '/textures/bricks/Brick_Wall_016_roughness.jpg',
    );
